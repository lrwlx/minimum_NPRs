...
class MSRS():
    def __init__(self, fun, bounds, k = 100, N = 10000):
        self.fun = fun
        self.bounds = bounds
    ...
    def find_global_min(self):
        ...
        for i in range(self.k):
            res = opt.minimize(fun= self.fun, x0=X_resample[i,:], bounds=self.bounds)
    ...
    def plot_res(self):
        ...
        plt.ylabel("min f")
        plt.title("minimal value of f"+" when k = "+str(self.k)+" num of paras= "+str(self.num_paras))
        plt.show()
    ...
    def save_results(self):
        ...
        best_theta_df.to_csv("min_v13_results/"+"LayerNum_"+str(self.num_paras)+"_SampleSize_"+str(self.k)+".csv")